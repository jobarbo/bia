  ...
  <div id="mc_embed_signup">
    <form action="//biaformations.us13.list-manage.com/subscribe/post?u=5651c764d0b83a317b47e6201&amp;id=44a1134806" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
      <div id="mc_embed_signup_scroll">
        ...
        <span class="formSelect">
          <select name="INT" class="custom-select sources required" id="mce-INT" placeholder="Intérêts">
            <option value=""></option>
            <option value="Nutrition">Nutrition</option>
            <option value="Psychologie sportive">Psychologie sportive</option>
          </select>
        </span>
        ...
        <div class="clear"><input class="submit" type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button"></div>
      </div>
    </form>
  </div>
